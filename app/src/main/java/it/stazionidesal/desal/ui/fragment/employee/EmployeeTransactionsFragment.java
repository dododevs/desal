...
import it.stazionidesal.desal.ui.activity.employee.TransactionsListActivity;
import it.stazionidesal.desal.ui.adapter.TransactionsQueueAdapter;
...
public class EmployeeTransactionsFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        transactionsListButton.setOnClickListener(v15 -> startActivity(new Intent(getContext(), TransactionsListActivity.class)
                .putExtra("station", Conditions.checkNotNull((EmployeeMainActivity) getActivity())
                .getSelectedStation())));
