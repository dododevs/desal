...
import revolver.desal.api.services.transactions.payment.Cash;
...
import revolver.desal.api.services.transactions.payment.PaymentMethod;
...
import revolver.desal.view.HorizontalNumberPicker;
...
public class EmployeeSaleFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mItem = checkNotNull(requireArguments().getParcelable("item"));
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setOnShowListener(dialog1 -> {
            ...
            mDialogBehavior = BottomSheetBehavior.from(checkNotNull(layout));
