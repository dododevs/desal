...
import revolver.desal.ui.activity.AddPricesActivity;
import revolver.desal.ui.activity.ShiftsArchiveActivity;
...
import revolver.desal.ui.activity.employee.ShiftActivity;
import revolver.desal.ui.callback.OnPricesRefreshRequested;
import revolver.desal.ui.fragment.EditPriceDialog;
...
public class EmployeeStationFragment extends Fragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final Drawable editPricesIcon = checkNotNull(IconUtils
        ...
        final Drawable shiftsArchiveIcon = checkNotNull(IconUtils
    ...
    private List<CardView> generateViewsForPrices(List<GasPrice> prices) {
        ...
        for (final GasPrice price : prices) {
            ...
            checkNotNull(pricesByFuel.get(price.getFuel())).add(price);
        }
        ...
        for (final Fuel fuel : pricesByFuel.keySet()) {
            ...
            List<GasPrice> pricesForFuel = checkNotNull(pricesByFuel.get(fuel));
